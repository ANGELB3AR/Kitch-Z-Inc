...
namespace AC
{
	...
	public class Player : NPC
	{
		...
		public override void _FixedUpdate ()
		{
			...
			{
				prepareToJump = false;
				_rigidbody.AddForce (UpDirection * KickStarter.settingsManager.jumpSpeed, ForceMode.Impulse);
			}
		...
		public bool Jump (bool mustBeGrounded = true, bool mustNotBeMidJump = true)
		{
			...
			if (activePath == null)
			{
				...
				else if (_rigidbody && !_rigidbody.isKinematic && (isGrounded || !mustBeGrounded))
				{
					...
					{
						_rigidbody.velocity = UpDirection * KickStarter.settingsManager.jumpSpeed;
					}
					isJumping = true;
