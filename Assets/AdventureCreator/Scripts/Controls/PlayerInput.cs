	...
	public class PlayerInput : MonoBehaviour
	{
		...
		public void SimulateInput (SimulateInputType input, string axis, float value)
		{
			if (!string.IsNullOrEmpty (axis))
			{
				...
				menuButtonValue = (input == SimulateInputType.Button) ? 1f : value;
		...
		protected float InputGetAxisRaw (string axis)
		{
			...
			if (!string.IsNullOrEmpty (menuButtonInput) && menuButtonInput == axis && menuInput == SimulateInputType.Axis && menuButtonValue != 0f)
			{
