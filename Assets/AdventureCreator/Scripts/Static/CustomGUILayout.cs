...
namespace AC
{
	...
	public class CustomStyles
	{
		...
		public static GUIStyle listIcon;
		...
		private static void Init ()
		{
			...
			listIcon = new GUIStyle (GUI.skin.button);
			listIcon.normal.background = (Texture2D) EditorGUIUtility.IconContent("LightmapEditor.WindowTitle").image;
			listIcon.fixedWidth = 25;
			listIcon.fixedHeight = 25;

			cogIcon = new GUIStyle (GUI.skin.button);
			cogIcon.normal.background = (Texture2D) EditorGUIUtility.IconContent("d_winbtn_mac_max_a").image;
			cogIcon.fixedWidth = 25;
			cogIcon.fixedHeight = 25;
