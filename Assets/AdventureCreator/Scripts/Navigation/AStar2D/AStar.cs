...
namespace AC.AStar2D
{
	...
	public class AStar : MonoBehaviour
	{
		...
		[SerializeField] private PolygonCollider2D navMesh = null;
		...
		private void DrawGizmos (PolygonCollider2D polygon)
		{
			if (polygon == null) return;

			Gizmos.DrawWireCube (polygon.bounds.center, polygon.bounds.size);
